...
class _MapScreenState extends State<MapScreen1> {
  ...
  void _setupLocationListener() {
    location.onLocationChanged.listen((LocationData locationData) {
      ...
      mapController.moveAndRotate(userLocation, 13, 90);
    });
  }
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text('You tapped on a point at ${tappedPoint.latitude}, ${tappedPoint.longitude}'),
              Text('Tap Position - Global: (${tapPosition}, ${tapPosition})'),
            ],
          ),
          actions: <Widget>[
            TextButton(
